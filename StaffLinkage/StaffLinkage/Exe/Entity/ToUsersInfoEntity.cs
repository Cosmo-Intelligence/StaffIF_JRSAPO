...
namespace StaffLinkage.Exe.Entity
{
    class ToUsersInfoEntity
    {
        ...
        /// エンティティ物理名
        /// </summary>
        public const string EntityName = "TOUSERSINFO";
        ...
        ///処理種別ID 登録：US01
        /// </summary>
        public const string REQUESTTYPE_0 = "0";

        /// <summary>
        ///処理種別ID 登録：US01
        /// </summary>
        public const string REQUESTTYPE_1 = "1";
        ...
        /// 日付最大値（変換後）
        /// </summary>
        public const string MAX_DATE_CONV = "99991231";
